...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="IntegrityVerificationFailedException" /> class with a specified error
    ///     message.
    /// </summary>
    ...
    /// </param>
    public IntegrityVerificationFailedException(string message, Exception innerException) : base(message,
        innerException)
    {
        // No additional logic needed for this constructor.
    }
